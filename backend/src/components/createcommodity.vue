  ...
  <div>
    ...
    <el-row :gutter="20">
      <el-col :span="12" class="topleft">
        <p class="mart">基础信息</p>
        <el-form  :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm mart">
          <el-row :gutter="20">
            <el-col :span="12">
            ...
            <el-col :span="24">
              <el-form-item label="类别：" prop="region">
                <el-select placeholder="请选择商品类别" v-model="ruleForm.region">
            ...
            <el-col :span="12">
              <el-form-item label="计费单位：">
                <el-radio-group v-model="ruleForm.billingMode" style="display:inline-block">
            ...
            <el-col :span="12">
              <el-form-item label="数值：">
                <el-input-number v-model='ruleForm.billingAmount' controls-position="right" :min="1" :max="10"></el-input-number>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="价格：">
                <el-input placeholder="请输入金额" v-model='ruleForm.unitPrice'>
            ...
            <el-col :span="24">
              <el-form-item>
                <el-input placeholder="请输入金额" v-model='ruleForm.sellingPrice'>
      ...
      <el-col :span="12">
        <div class="grid-content bg-purple-light">
          ...
          <el-col :span="24" class="mart">
            <el-input type="textarea" :autosize="{ minRows: 16, maxRows: 16}" placeholder="请输入内容" v-model="exceptions">
            </el-input>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <p class="mart">权益选择</p>
        <el-transfer v-model="benefitNumbers" style="text-align:center"  filterable class="mart" 
    ...
    }" @change="handleChange" :data="benefit">
        </el-transfer>
      </el-col>
      <el-col :span="12">
            ...
            <el-col :span="24">
              <el-form :rules="rules" label-width="100px" class="demo-ruleForm">
                <el-form-item label="直辖市：" class="mart">
                  <el-checkbox-group v-model="availableZones[0]" style="display:inline-block">
                ...
                <el-form-item label="华北：">
                  <el-checkbox-group v-model="availableZones[1]" style="display:inline-block">
                ...
                <el-form-item label="华东：" >
                  <el-checkbox-group v-model="availableZones[2]" style="display:inline-block">
                ...
                <el-form-item label="华南：">
                  <el-checkbox-group v-model="availableZones[3]" style="display:inline-block">
                ...
                <el-form-item label="华中：">
                  <el-checkbox-group v-model="availableZones[4]" style="display:inline-block">
                ...
                <el-form-item label="西北：">
                  <el-checkbox-group v-model="availableZones[5]" style="display:inline-block">
                ...
                <el-form-item label="西南：" >
                  <el-checkbox-group v-model="availableZones[6]" style="display:inline-block">
                ...
                <el-form-item label="东北：">
                  <el-checkbox-group  v-model="availableZones[7]" style="display:inline-block">
                ...
                <el-form-item label="港澳台：">
                  <el-checkbox-group  v-model="availableZones[8]" style="display:inline-block">
...
export default {
  ...
  methods: {
    ...
    save: function(callback) {
      var arr = [];
      var array = []
      this.availableZones.forEach(value => {
        arr = arr.concat(value);
      });
      this.benefitNumbers.forEach(value=>{
      ...
      var params = {
        ...
        billingMode: this.ruleForm.billingMode,
        billingAmount: this.ruleForm.billingAmount,
      ...
      this.http.post(url, params).then(data => {
        ...
        if(data.data.code==200){
         ...
         this.ruleForm.billingMode=''
         this.ruleForm.billingAmount=''
         this.ruleForm.unitPrice=''
         this.ruleForm.sellingPrice=''
         this.exceptions=''
         this.benefitNumbers=''
        this.availableZones=''
            this.$alert("保存成功", {

<template>
  <div class='container'>
    <div class="contact">
      <p style="font-size:18px;font-weight:700;">常用车辆</p>
      <router-link class="mui-tab-item" to='/vehicledetail'>
        <div>
...
<script>
  ...
  export default {
    ...
    methods: {
      _reload() {
        var url = `wechat/commonVehicle/list?userId=${window.sessionStorage.getItem('id')}`
      ...
      delOne(id) {
        console.log(id)
        var url = `wechat/commonVehicle/deleteById?id=${id}`

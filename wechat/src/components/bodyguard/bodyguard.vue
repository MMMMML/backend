    ...
    <div class="notice">
      ...
      <div v-show="show[0]" class='showText'>
        ...
        <p class='title_normal'>
          【基础10元】<br>
          包含一位权益人有效期内的直升机院前救援和地面120协调服务费用
        </p>
        <p class='title_normal'>
          【每次呼叫1元】<br>
      ...
      <div v-show='show[1]' class='showText'>
      ...
      <div v-show="show[3]" class="showText">
        ...
        <p class='title_normal' style="color:red">3、非事故车辆故障定义：“非单方或双方事故，未涉及保险理赔之一般机动车辆故障”</p>
      ...
      <div v-show="show[4]" class="showText">
        ...
        <p class='title_normal'>
          ● 权益人如需使用出险代步车服务，请携带本人驾驶证正副本、二代身份证、可用额度5000元以上国内信用卡(自驾押金预授权及交通违章押金)
          ● 益人上述所有证件有效期的剩余期限均须在一个月以上
          ● 相关费用须由权益人本人国内信用卡及国内借记卡支付，不接受现金付款
          ● 年度救援权益的用户，在符合服务标准的情况下可免费使用3次出险代步车服务，超过3次之后可享受空降联盟提供的租赁车尊享折扣礼券
      ...
      <div v-show="show[5]" class="showText">
        ...
        <p class='title_normal'>
          用户在需要救援时可拨打空降联盟救援服务热线( 400-111-9299)寻求帮助<br>

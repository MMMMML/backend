  ...
  <div class="container">
    ...
    <div class="notice">
      ...
      <div v-show="show[0]" class='showText'>
        ...
        <p class='title_normal'>有效期为所选权益日期，单人至多购买60天</p>
      ...
      <div v-show="show[5]" class="showText">
        ...
        <p class='title_normal'>
          ...
          &nbsp;&nbsp;（4）出险代步车服务费用：以车辆提供服务商的门店/官网公示价为准，因地域限制，如需更多资讯，请致电空降联盟服务热线 一般困境救援人民币500元起，如需吊车人民币1800元起；拖车起步价人民币200-500元（包含15Km），地库拖车人民币400-700元，如需架小轮服务，每小轮人民币80元；道路救援费用根据事发地点及救援难度会进行调整
        </p>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      let share = {
        title: '即刻雇佣飞行保镖，分秒守护你的旅途小时光！',
        desc: '都说我太过严肃，我只在意你是否需要保护',
        url: 'productB.jpg'
      }

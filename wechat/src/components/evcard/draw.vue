    ...
    <div class="container">
      ...
      <div class="agree">
        ...
        <div class="checkbox-wrap">
          <input ref="checkbox" type="checkbox" class="checkbox" value="guangpan"
          v-model="item.state" @click="alocked(item)" name="choose" id="guangpan">
          <label for="guangpan">
            <div class="agree-nav" style="font-size:14px;line-height: 20px;">
              &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 我已阅读并同意
      ...
      <div class="warp" v-if="ishow">
        ...
        <p>空降联盟为权益人提供以下服务：<br>
            1、服务类型： 院前救援服务<br>
            2、服务内容：（1）直升机空中运输（2）空中医疗救护（3）地面救护车协调<br>
            3、权益说明：权益期内，无限次呼叫直升机救援且每次需支付1元呼叫调度费<br>
        </p>
        <p class="warp-title">二、【服务前提】</p>
        <p>空降联盟为权益人提供以下服务：<br>
            1、权益人病症需符合本手册第四项约定的院前救援适应症<br>
            2、若地面救援无法及时到达或需要较长等待时间且危及生命安全，经120急救医生或我司授权医生确认后可提供空中直升机紧急医疗救援服务<br>
            3、气象条件、法律法规、空中管制等客观原因满足救援直升机适航条件<br>
            4、根据国际惯例及民航总局关于目视飞行的规定，救援直升机运行时间为每天 8：00 至日落前半小时；日落时间以各地气象局官网当天数据判定<br>
            备注：当地面救援可以及时到达并实施医疗救护时，将优先选择地面救援<br>
        </p>
        ...
        <p>（一）除外责任 <br>
            ...
            8、因医院医疗救治过错或过失导致被救援人伤情变重或死亡、空降联盟仅对飞行及运输安全负责<br>
            9、其他法律法规规定的免责事由<br>
            （二）限制责任 <br>
            ...
            5、权益人酒后驾驶、无合法有效驾驶证驾驶，或驾驶无有效行驶证的机动车而发生的后果 <br>
        </p>
      ...
      <div class="warp" v-if="ishow2">
          <div class="warp-nav">
              ...
              <p>请谨记空降联盟救援服务热线(<span style="color:red">021-60554929</span>)</p>
              <p>实际发生救援需求时:</p> 
  ...
  export default {
    ...
    methods: {
      ...
      handleConfirm: function (v) {
        ...
        let newDate = Date.parse(this.pickerStart)+24*60*60*1000*5

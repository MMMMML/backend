    ...
    top: 27.3rem;left: 12vw;padding-right: 10px;">
      ...
      <div class="warp" v-if="ishow2">
        <div class="warp-nav">
          ...
          <p>请谨记空降联盟救援服务热线(
            <span style="color:red">400-111-9299</span>)</p>
          <p>实际发生救援需求时:</p>
          ...
          <p>5、 本服务属于出行救援权益，请用户确保信息填写正确完整、如信息填写有误或需变更，请及时致电空降联盟服务热线进行修改（400-111-9299），因用户原因导致信息填写错误或未及时申请变更造成救援延误，空降联盟将不负相关责任</p>
